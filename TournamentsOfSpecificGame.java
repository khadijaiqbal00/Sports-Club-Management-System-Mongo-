 ...
 * @author DELL
 */
public class TournamentsOfSpecificGame extends javax.swing.JFrame {

    /**
     * Creates new form TournamentsOfSpecificGame
     */
    public TournamentsOfSpecificGame() {
        initComponents();
        addValues();
    }
    ...
    private void initComponents() {
        ...
        top1.setText("Viw No Tournaments of A specific Game");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TournamentsOfSpecificGame.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TournamentsOfSpecificGame().setVisible(true);
            }
        });
    }
