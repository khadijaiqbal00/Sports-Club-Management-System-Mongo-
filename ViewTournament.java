...
public class ViewTournament extends javax.swing.JFrame {
            ...
            try ( MongoCursor<Document> cursor = collection.find().cursor()) {
                try {
                    while (cursor.hasNext()) {
                        ...
                        Object[] row = { d.get("t_name").toString(),d.get("t_year").toString(), d.get("t_todate").toString() , d.get("t_fromdate").toString() , d.get("g_name").toString() };
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Year", "Starting Date", "Ending Date", "Game Name"
            }
        ) {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addComponent(top, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 645, Short.MAX_VALUE)
